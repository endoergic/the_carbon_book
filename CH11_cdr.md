...
2. Because installed capacity is a nameplate design figure, while delivery is verified, contracted CO₂ actually captured and stored — and the two have diverged sharply. Mammoth is the cautionary case: nominally 36 kt/yr, it had only ~12 of 72 collector containers installed through mid-2025, with the rest paused over sorbent/filter performance problems, so verified capture was on the order of *hundreds of tonnes* — well under 1% of nameplate — and Climeworks cut ~22% of staff in May 2025. Other capacity figures (e.g., Stratos's 500 kt/yr) are likewise design targets not yet achieved, and removals are only counted once monitored and verified, which further lags physical capture. So the ~1,200 tonnes reflects a genuinely immature, troubled-commissioning industry, not a bookkeeping artifact — the gap between nameplate and delivered tonnes *is* the early-CDR story.
